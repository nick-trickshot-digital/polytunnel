...
const searchTerms = {
  ...
  'Parsnips': 'parsnip vegetable root',
  'Swede': 'swede rutabaga vegetable',
  'Brussels Sprouts': 'brussels sprouts vegetable',
  'Cauliflower': 'cauliflower vegetable white',
  'Cabbage (Summer)': 'cabbage vegetable green',
  'Red Cabbage': 'red cabbage vegetable purple',
  'Purple Sprouting Broccoli': 'purple sprouting broccoli',
  'Asparagus': 'asparagus vegetable green',
  'Globe Artichoke': 'artichoke globe vegetable',
  'Jerusalem Artichoke': 'jerusalem artichoke sunchoke',
  'Blackberries': 'blackberry fruit fresh',
  'Gooseberries': 'gooseberry fruit fresh',
  'Redcurrants': 'redcurrant fruit red',
  'Blackcurrants': 'blackcurrant fruit',
  'Rhubarb': 'rhubarb stalks red',
  'Apples': 'apple fruit fresh red',
  'Pears': 'pear fruit fresh',
  'Cherries': 'cherry fruit fresh red',
  'Plums': 'plum fruit fresh purple',
  'Damsons': 'damson plum fruit',
  'Nectarines': 'nectarine fruit fresh',
  'Apricots': 'apricot fruit fresh',
  'Lavender': 'lavender flower purple',
  'Marjoram': 'marjoram herb fresh',
  'Bay': 'bay laurel leaves herb',
  'Shallots': 'shallot onion vegetable',
  'Onions (Spring Sets)': 'onion vegetable fresh',
  'Cape Gooseberries': 'cape gooseberry physalis fruit',
};
